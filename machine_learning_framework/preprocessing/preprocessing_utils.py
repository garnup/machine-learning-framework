...
from machine_learning_framework.utils.logging_utils import get_logger
...
def get_stats(df: pd.DataFrame, variable_list: List[str], percentile_list: List[str]):
    """
    ...
    Arguments:
        df - a data frame
        variable_list - list of variable names as strings
